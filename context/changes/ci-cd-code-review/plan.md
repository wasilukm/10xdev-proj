...
- [x] 3.1 Sticky script is executable and shellcheck-clean — 9c199b6
- [x] 3.2 Test-PR workflow run completes and reports a `verdict` output — 9c199b6
- [x] 3.3 No `issues: write` granted anywhere in `.github/` — 9c199b6

#### Manual

- [x] 3.4 Opening a PR posts exactly one marked comment with the score table — 9c199b6
- [x] 3.5 Pushing a second commit updates the same comment in place — 9c199b6
- [x] 3.6 Label transitions are correct in both directions; stale label removed — 9c199b6
- [x] 3.7 `ai-cr:review` re-runs the review and is removed afterwards, including on failure — 9c199b6
